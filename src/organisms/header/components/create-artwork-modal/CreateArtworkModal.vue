...
import { createArtworkStepSchemas } from './create-artwork.schema'
...
const currentSchema = computed(() => createArtworkStepSchemas[currentStep.value - 1])
            ...
            <section v-if="currentStep === 3" class="create-artwork__step details-step">
              <div class="details-step__form">
                ...
                <FormField class="details-step__field details-step__field_description">
                  ...
                  <Field name="description" v-model="form.description" v-slot="{ field }">
                    <BaseTextarea
                      v-bind="field"
                ...
                <div class="details-step__row details-step__row_copies">
                  <FormField class="details-step__field details-step__field_copies">
                    ...
                    <Field name="copies" v-model="form.copies" v-slot="{ field }">
                      <NumberInput
                        v-bind="field"
                        v-model="form.copies"
                        class="details-step__counter"
                      />
                    </Field>
                  </FormField>
                  <FormField class="details-step__field details-step__field_min-sum">
                    <template #label>Min.sum</template>
                    <Field name="minSum" v-model="form.minSum" v-slot="{ field }">
                      <TokenInput
                        v-bind="field"
                    ...
                    <ErrorMessage name="minSum" class="error-message" />
                  </FormField>
                </div>
